...
const listItem = z
  ...
  .max(80, 'Entries must be 80 characters or fewer.');
const list = (minimum = 0, message = '') =>
  z
    .array(listItem)
    .min(minimum, message)
    .max(20, 'Use no more than 20 entries.')
    .transform((items) => {
