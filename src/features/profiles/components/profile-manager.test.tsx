...
const profile: CandidateProfile = { id: "11111111-1111-4111-8111-111111111111", name: "Frontend specialist", desiredRoles: ["Frontend Engineer"], acceptedSeniorities: ["senior"], requiredSkills: ["React"], preferredSkills: [], excludedSkills: [], acceptedWorkModels: ["remote"], locations: ["Brazil"] };

describe("ProfileManager", () => {
  it("renders the create form and guides an empty profile list", () => {
    render(<ProfileManager profiles={[]} />);
    expect(screen.getByLabelText("Profile name")).toBeInTheDocument();
    expect(screen.getByText("No profiles yet. Create the first profile above to use the dashboard.")).toBeInTheDocument();
  });
