...
export default async function Home() {
  const [profileResult, companyResult] = await Promise.all([loadCandidateProfiles(), loadTargetCompanies()]);
  ...
  return <Dashboard profiles={profileResult.profiles} jobs={jobs} analyses={jobAnalyses} companies={companyResult.companies ?? []} companyError={companyResult.error} />;
}
