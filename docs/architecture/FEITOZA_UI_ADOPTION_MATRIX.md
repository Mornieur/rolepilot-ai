...
| `/companies/[companyId]/jobs-preview` | Greenhouse manual preview           | `Surface`, `Card`, `Button`, `Alert`                 | forms, links, headings, status text            | Lever preview remains planned                         |
...
| `/jobs/evaluate`                      | Result, Gemini analysis, decision   | `Card`, `Surface`, `Button`, `EmptyState`            | article, headings, lists, hidden inputs, links | Gemini history is persisted; reanalysis is explicit   |
